(*
	Creates new directories inside of the Capture directory. Does not set the capture directory.
...
on makeDirs(dirNames)
	tell front document of application "Capture One 11"
		...
		-- if the name is not Capture, we need to create out folder under the main Capture dir
